...
const updatePersonalDetails = async (req, res) => {
  try {
    ...
    if (req.body.idExpiryDate) updateFields.idExpiryDate = req.body.idExpiryDate;
    if (req.body.driverLicenseIssueDate) updateFields.driverLicenseIssueDate = req.body.driverLicenseIssueDate;
    ...
    logger.error(`Error updating personal details for ${phone}: ${error.message}`);
...
const updatePickupSchedule = async (req, res) => {
  try {
    ...
    logger.error(`Error updating pickup schedule for ${phone}: ${error.message}`);
...
const updateDropoffSchedule = async (req, res) => {
  try {
    ...
    logger.error(`Error updating dropoff schedule for ${phone}: ${error.message}`);
